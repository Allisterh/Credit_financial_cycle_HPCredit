...
prmtr_in(1:8) = priors_VAR2x(1:8);
prmtr_in(9) = priors_trend_stddev(1)
prmtr_in(10) = priors_VAR2x(9);
prmtr_in(11) = priors_trend_stddev(2);
prmtr_in(12) = priors_VAR2x(10)
prmtr_in(13) = priors_corr(1);
% prmtr_in(14) = priors_corr(2);
% 
% c_y_prior1 = -1;
% c_y_prior2 = -1.5;
