...
t_y_prior = priors_cycle(2,7);
t_y_prior2 = priors_cycle(1,7);
...
%Credit
prmtr_in = [0,0,0,0]';
prmtr_in(1:2)=priors_VAR2_credit(3:4);
prmtr_in(3) = priors_trend_stddev(2);
prmtr_in(4) = priors_VAR2_credit(10);
